...
class sim_FIR_types(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "sim_FIR_types")
...
def main(top_block_cls=sim_FIR_types, options=None):

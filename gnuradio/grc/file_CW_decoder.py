...
class file_CW_decoder(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.top_grid_layout.addWidget(self._tune_freq_win, 3, 0, 1, 50)
        for r in range(3, 4):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(0, 50):
            self.top_grid_layout.setColumnStretch(c, 1)
        self._thresh_low_range = qtgui.Range(0.00, 0.10, 0.01, 0.05, 10)
        ...
        self.top_grid_layout.addWidget(self._thresh_low_win, 3, 100, 1, 50)
        for r in range(3, 4):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(100, 150):
            self.top_grid_layout.setColumnStretch(c, 1)
        self._thresh_high_range = qtgui.Range(0.02, 1, 0.01, 0.1, 10)
        ...
        self.top_grid_layout.addWidget(self._thresh_high_win, 3, 150, 1, 50)
        for r in range(3, 4):
            self.top_grid_layout.setRowStretch(r, 1)
        ...
        self.top_grid_layout.addWidget(self._AGC_gain_win, 3, 50, 1, 50)
        for r in range(3, 4):
            self.top_grid_layout.setRowStretch(r, 1)
        ...
        self.top_grid_layout.addWidget(self._qtgui_waterfall_sink_x_0_win, 1, 5, 1, 145)
        for r in range(1, 2):
            self.top_grid_layout.setRowStretch(r, 1)
        ...
        self.top_grid_layout.addWidget(self._display_text_msg_0_win, 1, 150, 1, 50)
        for r in range(1, 2):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(150, 200):
            self.top_grid_layout.setColumnStretch(c, 1)
        ...
        # Connections
        ##################################################
        self.msg_connect((self.epy_block_0, 'text_out'), (self.display_text_msg_0, 'text'))
